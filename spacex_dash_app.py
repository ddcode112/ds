...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = filtered_df[filtered_df["Launch Site"] == 'CCAFS LC-40'][["Launch Site", "class"]]
        ...
        filtered_df = filtered_df[filtered_df["Launch Site"] == 'CCAFS SLC-40'][["Launch Site", "class"]]
        df = filtered_df.groupby(['class']).size().reset_index(name='counts')
        fig = px.pie(df, values='counts', 
        names='class', 
        ...
        filtered_df = filtered_df[filtered_df["Launch Site"] == 'KSC LC-39A'][["Launch Site", "class"]]
        df = filtered_df.groupby(['class']).size().reset_index(name='counts')
        fig = px.pie(df, values='counts',  
        names='class', 
        ...
        filtered_df = filtered_df[filtered_df["Launch Site"] == 'VAFB SLC-4E'][["Launch Site", "class"]]
        df = filtered_df.groupby(['class']).size().reset_index(name='counts')
        fig = px.pie(df, values='counts', 
        names='class', 
